# TikTok Uploader – Static Demo

Statische HTML/CSS/JS-Version, die als *GitHub Pages* gehostet werden kann.

**Dateien**
- `index.html` – Landing
- `app.html` – Demo-Upload (Drag & Drop, Logs; keine echte API)
- `legal.html` – Rechtliches
- `styles.css` – Styles
- `script.js` – Interaktivität
- `favicon.ico`, `robots.txt` – optional
